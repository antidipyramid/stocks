...
function makePages(assets) {
  ...
  document
    ...
    .children[1].setAttribute("class", "page-item active");
  ...
  document.getElementById("next-page").addEventListener("click", (e) => {
    if (!e.currentTarget.classList.contains("disabled")) {
      let page = document
        .querySelector(".pagination")
        .querySelector(".active")
        .querySelector(".page-link").innerHTML;
...
function createCard(asset) {
  ...
  col.setAttribute("class", "col-sm-6 col-md-4 col-xl-3 asset-card");
  document.getElementById("asset-cards").appendChild(col);

  let card = document.createElement("div");
  card.setAttribute("class", "card m-3 w-100 animated shadow-sm");
  ...
  div.innerHTML =
    asset.name + "  (<span class='ticker'>" + asset.ticker + "</span>)";
  ...
  card.addEventListener("mouseover", function (e) {
    e.currentTarget.setAttribute("class", "card m-3 w-100 animated shadow");
  ...
  card.addEventListener("mouseleave", function (e) {
    e.currentTarget.setAttribute("class", "card m-3 w-100 animated shadow-sm");
    // e.currentTarget.querySelector("small")
